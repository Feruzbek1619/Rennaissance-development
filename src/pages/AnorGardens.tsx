        ...
        <Container>
          <div className="relative">
            <div className="h-[460px] 2xl:h-[560px] w-full overflow-hidden rounded-[5px]">
              <iframe title={`${project.title} ${t('proj.onMap')}`} src="https://www.google.com/maps?q=41.33233,69.427917&z=16&output=embed" className="size-full border-0" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
            </div>
