...
const sections = [
  ...
  },
  {
    ...
    body: 'Все архитектурные проекты, планы, схемы и цифровые материалы на данной платформе защищены законодательством об интеллектуальной собственности. Использование, воспроизведение или распространение материалов без письменного разрешения Renaissance Development запрещено.',
  },
  {
  ...
  },
  {
    ...
    body: 'Renaissance Development не несёт ответственности за косвенные или случайные убытки, возникшие в результате использования сайта или наших услуг. Все материалы сайта предоставляются «как есть» без каких-либо гарантий.',
  },
  {
        ...
        <Container>
          <div className="flex items-start justify-between">
            ...
            <p className="font-body text-[20px] leading-[1.6] text-white/70 w-[580px] self-end">
              Ваше соглашение с Renaissance Development. Пожалуйста, ознакомьтесь с условиями
