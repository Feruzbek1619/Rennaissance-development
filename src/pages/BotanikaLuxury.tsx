...
const specIcons = [<HomeIcon />, <PinIcon />, <TagIcon />, <RulerIcon />, <LayersIcon />, <LayersIcon />, <RulerIcon />, <CarIcon />]
  ...
  return (
    <main>
      ...
      <section className="relative h-[720px] max-md:!h-[470px] 2xl:h-[888px] overflow-hidden bg-primary">
        <img loading="eager" decoding="async" src="/assets/botl-4.webp" alt={project.title} className="absolute inset-0 size-full object-cover" />
        {/* dark gradient */}
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-[28px] px-6 text-center">
          ...
          <div className="flex items-center gap-4 max-sm:flex-col max-sm:w-full max-sm:gap-3">
            ...
            <a
              href={SUPPORT_TEL}
              className="flex items-center justify-center max-sm:w-full rounded-[90px] bg-accent px-[32px] py-[16px] font-body text-[20px] font-medium leading-[1.6] text-bg-subtle hover:bg-[#A2814E] transition-colors"
            >
              {t('proj.callNow')}
            </a>
          </div>
