...
const sections = [
  ...
  },
  {
    ...
    body: 'Rennaissance development не продаёт ваши данные третьим лицам. Информация может передаваться только доверенным партнёрам, непосредственно участвующим в реализации вашего запроса, и только в объёме, необходимом для этого.',
  },
  {
    title: 'Ваши права',
        ...
        <Container>
          <div className="flex items-start justify-between">
            ...
            <p className="font-body text-[20px] leading-[1.6] text-white/70 w-[580px] self-end">
              Настоящая политика описывает, как Rennaissance development собирает, использует и защищает
