...
const vatanDetails: ProjectDetails = {
  description: [
    'Vatan Village — закрытый коттеджный городок компании Renaissance Development, воплощающий идею родового дома: пространства, которое строится однажды и остаётся семье навсегда. «Ватан» — родина на узбекском языке. Именно это слово точнее всего описывает концепцию проекта: не временное жильё, а дом с историей и будущим.',
    'Городок раскинулся на 5 гектарах закрытой охраняемой территории и объединяет около 90 коттеджей в едином неоклассическом архитектурном ансамбле. Один стандарт качества, один стиль, одно сообщество — это решение защищает стоимость каждого дома: через двадцать лет квартал будет выглядеть так же цельно, как в день сдачи. Участки площадью от 2,5 до 7 соток оформляются в собственность.',
  ],
  specs: {
    address: 'Ташкент, Мирзо-Улугбекский район',
    area: 'от 63,0 до 106,0 м²',
    floors: '3 этажа',
    category: 'Комфорт+',
    year: '2027',
    status: 'Строится',
