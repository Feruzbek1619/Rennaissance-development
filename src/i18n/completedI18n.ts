...
const en: Record<string, CompletedTr> = {
  ...
  yakkasaroy: {
    ...
    specs: [
      ...
      { label: 'Apartments area', value: '5,099 m²' },
...
const uz: Record<string, CompletedTr> = {
  'western-housing': {
    ...
    specs: [
      ...
      { label: 'Xonadonlar maydoni', value: '16 425 m²' },
      { label: 'Avtoturargoh maydoni', value: '500 m²' },
  ...
  renaissance: {
    ...
    specs: [
      ...
      { label: 'Xonadonlar maydoni', value: '22 883 m²' },
      { label: 'Avtoturargoh maydoni', value: '3 292 m²' },
  ...
  yakkasaroy: {
    ...
    specs: [
      ...
      { label: 'Loyiha maydoni', value: '0,15 gektar' },
      { label: 'Xonadonlar maydoni', value: '5 099 m²' },
      { label: 'Avtoturargoh maydoni', value: '300 m²' },
  ...
  botanika: {
    ...
    specs: [
      ...
      { label: 'Loyiha maydoni', value: '0,3 gektar' },
      { label: 'Xonadonlar maydoni', value: '19 960 m²' },
      { label: 'Avtoturargoh maydoni', value: '15 968 m²' },
