export default {
  ...
  proj: {
    ...
    nearby: [
      { icon: 'sparkles', title: 'Yangi O‘zbekiston bog‘i' },
      { icon: 'star', title: 'Yangi Toshkent markazi' },
      { icon: 'bus', title: 'Xalqaro aeroport' },
      { icon: 'graduation', title: 'Universitetlar' },
      { icon: 'graduation', title: 'Maktablar' },
      { icon: 'star', title: 'Bolalar bog‘chalari' },
      { icon: 'cart', title: 'Savdo markazlari' },
    ],
    ...
    pages: {
      "sharq-avenue": {
        ...
        specs: [
          ...
          { label: "Loyiha maydoni", value: "3 gektar" },
          { label: "Bloklar", value: "12 blok · 5 qavat" },
          { label: "Kvartiralar", value: "547" },
          { label: "Xonadonlar maydoni", value: "46 983 m²" },
          { label: "Savdo maydonlari", value: "2 590 m²" },
          { label: "Avtoturargoh maydoni", value: "18 424 m²" },
        ],
      },
      "anor-gardens": {
        ...
        specs: [
          ...
          { label: "Manzil", value: "Toshkent, Mirzo Ulug‘bek tumani" },
          { label: "Loyiha maydoni", value: "1,4 gektar" },
          { label: "Bloklar", value: "3 blok · 5 qavat" },
          { label: "Kvartiralar", value: "189" },
          { label: "Xonadonlar maydoni", value: "10 483 m²" },
          { label: "Avtoturargoh maydoni", value: "7 244 m²" },
        ],
      },
      "botanika-luxury": {
        ...
        advantages: [
          ...
          { title: "Yer usti va yerosti avtoturargohlari", desc: "Aholi uchun qulay avtoturargoh yechimlari, jumladan 20 765 m² maydonli zamonaviy yerosti avtoturargohi ko‘zda tutilgan — yilning istalgan faslida qulaylik va xavfsizlik." },
        ...
        specs: [
          ...
          { label: "Loyiha maydoni", value: "2,5 gektar" },
          { label: "Bloklar", value: "7 blok · 11 kirish" },
          { label: "Qavatlar", value: "10–11 qavat" },
          { label: "Xonadonlar maydoni", value: "30 390 m²" },
          { label: "Avtoturargoh maydoni", value: "20 765 m²" },
        ],
      },
      "vatan-village": {
        ...
        specs: [
          ...
          { label: "Manzil", value: "Toshkent, Mirzo Ulug‘bek tumani" },
          { label: "Toifa", value: "Komfort+" },
          { label: "Loyiha hududi", value: "4,5 gektar" },
          { label: "Kottej", value: "90" },
          { label: "Qurilish maydoni", value: "19 500 m²" },
          { label: "Avtoturargoh maydoni", value: "110 mashina-o‘rin" },
        ],
      },
    },
  },
