    ...
    pages: {
      "sharq-avenue": {
        ...
        specs: [
          ...
          { label: "Xonadonlar maydoni", value: "58 728 m²" },
          { label: "Savdo maydonlari", value: "3 237 m²" },
          { label: "Avtoturargoh maydoni", value: "1 900 m²" },
        ],
      },
      "anor-gardens": {
        ...
        specs: [
          ...
          { label: "Xonadonlar maydoni", value: "13 103,75 m²" },
      ...
      "botanika-luxury": {
        ...
        advantages: [
          ...
          { title: "Yer usti va yerosti avtoturargohlari", desc: "Aholi uchun qulay avtoturargoh yechimlari, jumladan 3 100 m² maydonli zamonaviy yerosti avtoturargohi ko‘zda tutilgan — yilning istalgan faslida qulaylik va xavfsizlik." },
        ...
        specs: [
          ...
          { label: "Avtoturargoh maydoni", value: "3 100 m²" },
        ],
      },
      "vatan-village": {
        ...
        specs: [
          ...
          { label: "Manzil", value: "Toshkent, Mirzo Ulug‘bek tumani" },
          { label: "Toifa", value: "Komfort+" },
          { label: "Loyiha hududi", value: "460 sotix" },
          { label: "Kottej", value: "qariyb 90" },
          { label: "Har bir kottej yer maydoni", value: "3 dan 7 sotixgacha" },
