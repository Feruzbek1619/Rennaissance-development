export default {
  ...
  pages: {
    ...
    blog: {
      heroTitle: "News, Insights & Articles",
      heroDesc: "Industry trends, company news and practical materials about construction.",
      filters: ["All", "Trends", "Construction", "Technology", "Safety", "Ecology"],
      readMore: "Read",
      backToBlog: "Blog",
      readingSuffix: "read",
      tagsLabel: "Tags:",
      extraTags: ["Construction", "Uzbekistan"],
      aboutTag: "About the company",
      aboutDesc: "A full-cycle developer. Our own UTB plant, design, construction and turnkey handover of projects.",
      sectionsTitle: "Sections",
      navLabels: ["Projects", "Services", "About the company", "B2B / Production", "Contact"],
      consultTitle: "Need a consultation?",
      consultDesc: "Ask a question about construction or purchasing real estate.",
      relatedTitle: "Related articles",
      allArticles: "All articles",
    },
    services: {
      heroTitle: "Mastering the Art of Structural Precision.",
      heroDesc: "From design to handover of the keys — a full construction cycle with in-house production.",
      heroCta: "Get a consultation",
      tag: "Services",
      whatTitle: "What we do",
      whatDesc: "A range of construction services from residential complexes to the production of building materials.",
      processTag: "Process",
      howTitle: "How we work",
      processCta: "More about the process",
      aboutTag: "About the service",
      whatIncluded: "What the service includes",
      relatedTitle: "Similar projects",
      steps: [
        { num: "01", title: "Analysis and design", body: "We study requirements, form the concept and develop full project documentation." },
        { num: "02", title: "Material production", body: "The UTB plant produces concrete, reinforced-concrete products and aerated blocks for the specific project with full quality control." },
        { num: "03", title: "Construction and handover", body: "Monolithic frame, engineering systems, finishing and handover of the project on schedule." },
      ],
      processSteps: [
        { num: "01", title: "Initial consultation", body: "We discuss requirements, timelines and budget. We draw up the technical brief." },
        { num: "02", title: "Design", body: "We develop the architectural concept and full working documentation." },
        { num: "03", title: "Production and supply", body: "The UTB plant produces all the necessary materials with quality control." },
        { num: "04", title: "Construction", body: "We carry out construction in accordance with the project and the set schedule." },
      ],
    },
    process: {
      heroTitle: "Strategic Execution.",
      heroDesc: "Three stages — one quality standard. A full cycle from design to project handover.",
      heroCta: "Discuss the project",
      stages: [
        { num: "01", title: "Design", subtitle: "Concept → working documentation", body: "We start with a detailed analysis of the site and requirements. The design team develops the architectural concept, structural solutions and complete working documentation. All projects comply with the standards of the Republic of Uzbekistan.", details: ["Architectural concept", "Structural solutions", "Engineering systems (plumbing, HVAC, electrical)", "Working documentation", "BIM modeling", "Author supervision"] },
        { num: "02", title: "Production", subtitle: "UTB plant → construction site", body: "The Universal Temir Beton plant produces all key materials: ready-mix concrete, reinforced-concrete products, aerated blocks, ventilation shafts and thermal frames. In-house production means direct control of quality and delivery times.", details: ["Ready-mix concrete of all grades", "Reinforced-concrete products", "Aerated concrete blocks", "Ventilation shafts", "Thermal frames", "Logistics to the site"] },
        { num: "03", title: "Construction", subtitle: "Frame → keys", body: "A monolithic concrete frame, brick façade, engineering systems and finishing. Each stage is recorded in the quality-control system. The project is delivered on schedule with a full documentation package.", details: ["Monolithic frame", "Brick façade", "Engineering systems", "Finishing works", "Site landscaping", "Handover and documentation"] },
      ],
      stats: [
        { value: "12+", label: "Completed projects" },
        { value: "2019", label: "Year founded" },
        { value: "2021", label: "UTB plant launch" },
        { value: "100%", label: "Own materials" },
      ],
    },
    privacy: {
      heroTag: "Legal",
  ...
  proj: {
    ...
    nearby: [
      { icon: 'sparkles', title: 'Yangi Uzbekiston Park' },
      { icon: 'star', title: 'Yangi Tashkent center' },
      { icon: 'bus', title: 'International airport' },
      { icon: 'graduation', title: 'Universities' },
      { icon: 'graduation', title: 'Schools' },
      { icon: 'star', title: 'Kindergartens' },
      { icon: 'cart', title: 'Shopping centers' },
    ],
    ...
    pages: {
      "sharq-avenue": {
        ...
        specs: [
          ...
          { label: "Living area", value: "46,983 m²" },
          { label: "Commercial", value: "2,590 m²" },
          { label: "Parking", value: "18,424 m²" },
        ],
      },
      "anor-gardens": {
        whyTag: "Why Anor Gardens",
        intro: "«Anor Gardens» is a cosy, private club complex on 1.4 hectares: just 5 residential blocks 5 storeys high and 137 apartments. A gated guarded territory, underground parking and landscaped recreation areas — a calm and comfortable environment for the whole family.",
        interiorText: "These are spacious rooms with huge stained-glass windows. Each of them has an elevator up to the private courtyard, fully in line with the barrier-free concept. Parcel lockers will be installed for receiving deliveries.",
        interior: ["High-speed elevators", "Stained-glass windows", "Metal doors", "Soft lighting"],
        advantages: [
          { title: "Gated guarded territory", desc: "Controlled entry and video surveillance across the entire territory — a calm and safe environment for the whole family." },
          { title: "Club format — 137 apartments", desc: "Just 137 functionally planned apartments: privacy, quiet and a thoughtful use of space." },
          { title: "5 blocks of 5 floors", desc: "Low-rise comfort-class club development: 5 residential blocks 5 storeys high on a 1.4-hectare territory." },
          { title: "Underground parking", desc: "A spacious underground parking — cars are kept under the building, while the courtyard stays free and safe." },
          { title: "Landscaped courtyards", desc: "Green courtyards, walking alleys and recreation areas for family leisure outdoors." },
          { title: "A modern lifestyle", desc: "A private and cosy environment that harmoniously combines safety, comfort and quality of life." },
        ],
        specs: [
          ...
          { label: "Blocks", value: "3 blocks · 5 floors" },
          { label: "Apartments", value: "189" },
      ...
      "botanika-luxury": {
        ...
        advantages: [
          ...
          { title: "Above-ground and underground parking", desc: "Convenient parking solutions are provided for residents, including a modern underground parking of 20,765 m² — comfort and safety in any season." },
        ...
        specs: [
          ...
          { label: "Development", value: "2.5 hectares" },
          { label: "Blocks", value: "7 blocks · 11 entrances" },
          { label: "Floors", value: "10–11 floors" },
          { label: "Living area", value: "30,390 m²" },
          { label: "Parking", value: "20,765 m²" },
        ],
      },
      "vatan-village": {
        ...
        specs: [
          ...
          { label: "Address", value: "Tashkent, Mirzo-Ulugbek district" },
          { label: "Category", value: "Comfort+" },
          { label: "Territory", value: "4.5 hectares" },
          { label: "Cottages", value: "90" },
          { label: "Development", value: "19,500 m²" },
          { label: "Parking", value: "110 spaces" },
        ],
      },
    },
  },
