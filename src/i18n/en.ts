    ...
    pages: {
      ...
      "anor-gardens": {
        ...
        specs: [
          ...
          { label: "Blocks", value: "5 blocks · 5 floors" },
          { label: "Apartments", value: "137" },
          { label: "Living area", value: "13,103.75 m²" },
      ...
      "botanika-luxury": {
        ...
        advantages: [
          ...
          { title: "Above-ground and underground parking", desc: "Convenient parking solutions are provided for residents, including a modern underground parking of 3,100 m² — comfort and safety in any season." },
